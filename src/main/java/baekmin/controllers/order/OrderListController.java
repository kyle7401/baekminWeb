package baekmin.controllers.order;

import baekmin.Service.IOrderListService;
import baekmin.Service.ITbBranchService;
import baekmin.Service.ITbCodeService;
import baekmin.Service.TbCodeService;
...
//        오늘및 주및 월 from
    ...
    public View planExcel(Model model,
        ...
        model.addAttribute("out_fname", "백민입고예정 현황"); // 다운로드 받을 엑셀 파일명
...
//        오늘및 주및 월 from
    ...
    public View stockExcel(Model model,
        ...
        model.addAttribute("out_fname", "백민입고 현황"); // 다운로드 받을 엑셀 파일명
