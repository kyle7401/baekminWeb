...
import baekmin.domain.TbEmployee;
import baekmin.domain.TbManager;
import baekmin.domain.TbPartMember;
...
//        baekmin.domain.User user = userRepository.findByUsername(username);

        baekmin.viewmodel.User user = null;
...
//                TbManager tmpUser1 = TbManagerService.findByMgEmail(username);
                ...
                if(tmpUser1 != null) {
                    user = new baekmin.viewmodel.User();
...
//        org.springframework.security.core.userdetails.User 에 없는 추가 정보 사용
    ...
    private User buildUserForAuthentication(baekmin.viewmodel.User user, List<GrantedAuthority> authorities) {
